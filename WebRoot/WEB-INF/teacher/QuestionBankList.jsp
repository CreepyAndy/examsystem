...
<s:iterator value="qcs" var="qc">
    <tr>
	  ...
	  <td><a href="<%=basePath%>paperManage/synPaper_decide?qid=<s:property value="id"/>&paperId=<%=session.getAttribute("paperId")%>">选择这题</a></td>
	</tr>
</s:iterator>
</table>
<p align="center"><a href="<%=basePath%>paperManage/synPaper_chosen.action">查看已选的试题</a></p>
<s:debug></s:debug>
  </body>
</html>
